...
<div class="row ">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="teacher-form" action="{{ route('admin.teacher.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="classes[]"  multiple>
                            ...
                            <option value="{{ $class->id}}" @if(in_array($class->id,old('classes',[])))selected @endif > {{ $class->class_title }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-primary" id="btn_save_details">Save Teacher</button>    
                    </div>  
                </form>
            </div>
        </div>    
