...
<script type="text/javascript">
    $(document).ready(function(){
        var title = "Released Chapter {{ $page_title }}";
        $("#items-table").DataTable({
            ...
            language: {
                emptyTable: "No release chapters found.",
            },
            columnDefs: [
                { targets: [0,1,2,3,4,5,6], className: "text-center" },
                { targets: [1,2,3,4,5,6], sortable: false },
                { targets: [2,6], width: "120px" }
            ]
        });
