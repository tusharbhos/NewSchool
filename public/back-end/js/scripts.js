...
function changeImage(mode){
  ...
  // var images      = document.getElementsByClassName('logo-name');
  // var headerLogo  = document.getElementsByClassName('header-logo');

  // if(mode == 0){
  //   // DARK
  //   if (images.length > 0) {
  //       images[0].src = 'https://lms.cdxonline.in/back-end/img/logo-footer-02.svg';
  //       images[0].alt = 'CDX - LMS';
  //   } else {
  //       console.error('No element found with the specified logo-name name');
  //   }

  //   if (headerLogo.length > 0) {
  //       headerLogo[0].src = 'https://lms.cdxonline.in/back-end/img/logo-icon-02.svg';
  //       headerLogo[0].alt = 'CDX';
  //   } else {
  //       console.error('No element found with the specified header-logo name');
  //   }
  // }else{
  //   // LIGHT
  //   if (images.length > 0) {
  //       images[0].src = 'https://lms.cdxonline.in/back-end/img/logo-01.svg';
  //       images[0].alt = 'CDX - LMS';
  //   } else {
  //       console.error('No element found with the specified logo-name name');
  //   }
  ...
  //   if (headerLogo.length > 0) {
  //       headerLogo[0].src = 'https://lms.cdxonline.in/back-end/img/logo-icon-01.svg';
  //       headerLogo[0].alt = 'CDX';
  //   } else {
  //       console.error('No element found with the specified header-logo name');
  //   }
